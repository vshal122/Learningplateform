...
import com.example.learningplateform.services.core.impl.UserService;
...
public class SecurityController {
    ...
    private final RegisterRepository matriculaRepository;
    ...
    public String getUserProfile(Authentication authentication, Model model) {
        try {
            ...
            List<Register> matriculas = matriculaRepository.findAllByUsuario(user);
